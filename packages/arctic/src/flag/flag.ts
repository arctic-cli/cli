export namespace Flag {
  ...
  export const ARCTIC_PERMISSION_PROFILE = process.env["ARCTIC_PERMISSION_PROFILE"]
  ...
  export const ARCTIC_EXPERIMENTAL_ICON_DISCOVERY = ARCTIC_EXPERIMENTAL || truthy("ARCTIC_EXPERIMENTAL_ICON_DISCOVERY")
