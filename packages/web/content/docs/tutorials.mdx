...
- Explore [Agents](/docs/cli/agents) for specialized workflows
- Learn about [Custom Commands](/docs/cli/commands) for reusable prompts
- Check [Config](/docs/cli/config) to customize Arctic for your workflow
